let brick = new Brick(new Vector3(-383,-17,132), new Vector3(1,1,6), "#deca31")
...
// Settings \\
swordDamage = 50 // How much damage does the sword deal when clicked?
swordRange = 2 // How far can the sword hit players?
swordModelID = 31683 // The mesh of the sword from the store ID
...
p.topPrint("You've picked Illumina sword")
p.equipTool(tool)


brick.setPosition(new Vector3(555,555,555));
setTimeout(() => {brick.setPosition(new Vector3(-383,-17,132));}, 60000);//1,0,7
